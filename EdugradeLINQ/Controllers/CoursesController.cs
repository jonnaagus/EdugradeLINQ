...
namespace EdugradeLINQ.Controllers
{
    public class CoursesController : Controller
    {
        ...
        [HttpPost]
        public IActionResult UpdateCourseName(string currentCourseName, string newCourseName)
        {
            var course = _context.Courses.FirstOrDefault(c => c.CourseName == currentCourseName);
            if (course == null)
            {
                return NotFound();
            }
            ...
            ViewData["Message"] = $"Kursnamnet har uppdaterats från {currentCourseName} till {newCourseName}";
